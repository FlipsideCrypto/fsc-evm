...
{% set uses_etherscan = get_var('GLOBAL_PROD_DB_NAME','').upper() not in excludes_etherscan %}
{% set uses_result_output_abi = get_var('GLOBAL_PROD_DB_NAME','').upper() in includes_result_output_abi %}
