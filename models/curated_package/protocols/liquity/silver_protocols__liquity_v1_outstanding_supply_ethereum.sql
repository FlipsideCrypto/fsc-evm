...
{#
    Liquity V1 Outstanding LUSD Supply - Ethereum

    Tracks the net LUSD supply on Ethereum by monitoring mints and burns
...
WITH supply_changes AS (
    ...
    WHERE contract_address = LOWER('0x5f98805a4e8be255a32880fdec7f6728c6568ba0')
    AND (
