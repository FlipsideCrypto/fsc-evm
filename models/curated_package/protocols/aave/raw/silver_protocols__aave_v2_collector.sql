...
, flows AS (
    SELECT
        ...
        , contract_address
        , priced_token
        , SUM(CASE WHEN to_address = LOWER('{{ collector_v2 }}') THEN amount ELSE 0 END) AS amount_in
        , SUM(CASE WHEN from_address = LOWER('{{ collector_v2 }}') THEN amount ELSE 0 END) AS amount_out
