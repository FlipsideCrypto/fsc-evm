...
{{ config(
  ...
  cluster_by = ['block_timestamp::DATE','platform'],
      -- post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(tx_hash, contract_address, pool_address, pool_name, tokens, symbols), SUBSTRING(pool_address, pool_name, tokens, symbols)", -- Moved to daily_search_optimization maintenance model
