...
WITH evt AS (
    SELECT
        ...
        TRY_TO_NUMBER(token_amounts [0] :: STRING) AS amount0_unadj,
        TRY_TO_NUMBER(token_amounts [1] :: STRING) AS amount1_unadj,
        TRY_TO_NUMBER(token_amounts [2] :: STRING) AS amount2_unadj,
        TRY_TO_NUMBER(token_amounts [3] :: STRING) AS amount3_unadj,
        TRY_TO_NUMBER(token_amounts [4] :: STRING) AS amount4_unadj,
        TRY_TO_NUMBER(token_amounts [5] :: STRING) AS amount5_unadj,
        TRY_TO_NUMBER(token_amounts [6] :: STRING) AS amount6_unadj,
        TRY_TO_NUMBER(token_amounts [7] :: STRING) AS amount7_unadj,
