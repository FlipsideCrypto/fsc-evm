...
SELECT
    ...
    TRY_TO_NUMBER(amount0_unadj) AS amount0_unadj,
    TRY_TO_NUMBER(amount1_unadj) AS amount1_unadj,
    TRY_TO_NUMBER(amount2_unadj) AS amount2_unadj,
    TRY_TO_NUMBER(amount3_unadj) AS amount3_unadj,
    TRY_TO_NUMBER(amount4_unadj) AS amount4_unadj,
    TRY_TO_NUMBER(amount5_unadj) AS amount5_unadj,
    TRY_TO_NUMBER(amount6_unadj) AS amount6_unadj,
    TRY_TO_NUMBER(amount7_unadj) AS amount7_unadj,
    fee0,
    fee1,
    fee2,
    fee3,
