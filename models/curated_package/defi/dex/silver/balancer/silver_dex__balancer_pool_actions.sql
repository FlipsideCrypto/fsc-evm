...
WITH evt AS (
    SELECT
        ...
        deltas [0] :: STRING AS amount_0,
        deltas [1] :: STRING AS amount_1,
        deltas [2] :: STRING AS amount_2,
        deltas [3] :: STRING AS amount_3,
        deltas [4] :: STRING AS amount_4,
        deltas [5] :: STRING AS amount_5,
        deltas [6] :: STRING AS amount_6,
        deltas [7] :: STRING AS amount_7,
        decoded_log :protocolFeeAmounts AS protocol_fee_amounts,
        protocol_fee_amounts [0] :: STRING AS protocol_fee_amount_0,
        protocol_fee_amounts [1] :: STRING AS protocol_fee_amount_1,
        protocol_fee_amounts [2] :: STRING AS protocol_fee_amount_2,
        protocol_fee_amounts [3] :: STRING AS protocol_fee_amount_3,
        protocol_fee_amounts [4] :: STRING AS protocol_fee_amount_4,
        protocol_fee_amounts [5] :: STRING AS protocol_fee_amount_5,
        protocol_fee_amounts [6] :: STRING AS protocol_fee_amount_6,
        protocol_fee_amounts [7] :: STRING AS protocol_fee_amount_7,
        p.protocol,
        p.version,
        p.type,
        CONCAT(
