...
mint AS (
    SELECT
        ...
        utils.udf_hex_to_int(segmented_data[1]::STRING)::FLOAT AS liquidity_amount,
        utils.udf_hex_to_int(segmented_data[2]::STRING)::FLOAT AS amount0,
        utils.udf_hex_to_int(segmented_data[3]::STRING)::FLOAT AS amount1,
        protocol,
        version,
        type,
        platform,
...
burn AS (
    SELECT
        ...
        utils.udf_hex_to_int(segmented_data[0]::STRING)::FLOAT AS liquidity_amount,
        utils.udf_hex_to_int(segmented_data[1]::STRING)::FLOAT AS amount0,
        utils.udf_hex_to_int(segmented_data[2]::STRING)::FLOAT AS amount1,
        protocol,
        version,
        type,
        platform,
...
all_actions AS (
    SELECT
        ...
        liquidity_amount AS amount_unadj,
