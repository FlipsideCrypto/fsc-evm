...
SELECT
  ...
  OBJECT_CONSTRUCT(
    'token0',
    TRY_TO_NUMBER(amount0::STRING),
    'token1',
    TRY_TO_NUMBER(amount1::STRING),
    'token2',
    TRY_TO_NUMBER(amount2::STRING),
    'token3',
    TRY_TO_NUMBER(amount3::STRING),
    'token4',
    TRY_TO_NUMBER(amount4::STRING),
    'token5',
    TRY_TO_NUMBER(amount5::STRING),
    'token6',
    TRY_TO_NUMBER(amount6::STRING),
    'token7',
    TRY_TO_NUMBER(amount7::STRING)
  ) AS amounts,
  OBJECT_CONSTRUCT(
    'token0',
    TRY_TO_NUMBER(amount0_usd::STRING),
    'token1',
    TRY_TO_NUMBER(amount1_usd::STRING),
    'token2',
    TRY_TO_NUMBER(amount2_usd::STRING),
    'token3',
    TRY_TO_NUMBER(amount3_usd::STRING),
    'token4',
    TRY_TO_NUMBER(amount4_usd::STRING),
    'token5',
    TRY_TO_NUMBER(amount5_usd::STRING),
    'token6',
    TRY_TO_NUMBER(amount6_usd::STRING),
    'token7',
    TRY_TO_NUMBER(amount7_usd::STRING)
  ) AS amounts_usd,
  OBJECT_CONSTRUCT(
    'token0',
    token0_is_verified,
