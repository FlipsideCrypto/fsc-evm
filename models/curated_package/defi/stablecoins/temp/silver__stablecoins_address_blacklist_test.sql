...
usdt0_blacklist AS (
    SELECT
        ...
        event_index,
        CASE
            WHEN topic_0 = '0x406bbf2d8d145125adf1198d2cf8a67c66cc4bb0ab01c37dccd4f7c0aae1e7c7' THEN 'AddedBlacklist'
            ELSE 'RemovedBlacklist'
        END AS event_name,
        contract_address,
        '0x' || SUBSTR(
    ...
    WHERE
        topic_0 :: STRING IN (
            ...
            --USDT0 BlockPlaced
            '0x665918c9e02eb2fd85acca3969cb054fc84c138e60ec4af22ab6ef2fd4c93c27'
        ) --USDT BlockReleased
),
usdc_blacklist AS (
    SELECT
        ...
        event_index,
        CASE
            WHEN topic_0 = '0xffa4e6181777692565cf28528fc88fd1516ea86b56da075235fa575af6a4b855' THEN 'AddedBlacklist'
            ELSE 'RemovedBlacklist'
        END AS event_name,
        contract_address,
        '0x' || SUBSTR(
...
all_blacklist AS (
    ...
    SELECT
        *
    FROM
        usdc_blacklist {# {% if is_incremental() and var(
        'HEAL_MODEL',
        FALSE
) %}
UNION
