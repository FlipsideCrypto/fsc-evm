...
euler AS (
    ...
    SELECT
        ...
        A.event_name
    FROM
        {{ ref('silver__euler_repayments') }} A
    WHERE
        token_symbol IS NOT NULL
...
aave_ethereum AS (
    SELECT
        ...
        A.event_name
    FROM
        {{ ref('silver__aave_ethereum_repayments') }} A
    WHERE
        token_symbol IS NOT NULL
...
fraxlend AS (
    SELECT
        ...
        A.event_name
    FROM
        {{ ref('silver__fraxlend_repayments') }} A
    WHERE
        token_symbol IS NOT NULL
...
comp_v2_fork AS (
    SELECT
        ...
        A.event_name
    FROM
        {{ ref('silver__comp_v2_repayments') }} A
...
morpho AS (
    SELECT
        ...
        A.event_name
    FROM
        {{ ref('silver__morpho_repayments') }} A
    WHERE
        token_symbol IS NOT NULL
