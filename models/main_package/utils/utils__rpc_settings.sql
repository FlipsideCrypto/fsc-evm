...
select 
    ...
    array_contains('accessList'::VARIANT, txs_fields) as tx_has_access_list,
    array_contains('maxFeePerGas'::VARIANT, txs_fields) as tx_has_max_fee_per_gas,
    array_contains('maxPriorityFeePerGas'::VARIANT, txs_fields) as tx_has_max_priority_fee_per_gas,
    array_contains('blobGasPrice'::VARIANT, txs_fields) as tx_has_blob_gas_price,
    array_contains('sourceHash'::VARIANT, txs_fields) as tx_has_source_hash,
    array_contains('mint'::VARIANT, txs_fields) as tx_has_mint,
    array_contains('ethValue'::VARIANT, txs_fields) as tx_has_eth_value,
    array_contains('yParity'::VARIANT, txs_fields) as tx_has_y_parity,
    ...
    array_contains('maxFeePerGas'::VARIANT, txs_fields) as tx_has_eip_1559
