...
{{ config (
    ...
    -- post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(block_number,tx_hash,contract_address,origin_from_address,origin_to_address,origin_function_signature,topic_0)", -- Moved to daily_search_optimization maintenance model
