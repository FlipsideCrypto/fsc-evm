...
{% if vars.GLOBAL_GOLD_FR_ENABLED is none and var('TEMP_LOGS_FR_ENABLED', false) %}
    ...
    SELECT
        ...
        CASE WHEN l.block_timestamp >= date_trunc('hour',SYSDATE()) - interval '6 hours' THEN SYSDATE() 
