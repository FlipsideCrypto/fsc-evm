{{ config (
    ...
    post_hook = fsc_utils.if_data_call_function_v2(
        ...
        params = {
            ...
            "sql_limit": {{MAIN_SL_BLOCKS_TRANSACTIONS_REALTIME_SQL_LIMIT}},
            "producer_batch_size": {{MAIN_SL_BLOCKS_TRANSACTIONS_REALTIME_PRODUCER_BATCH_SIZE}},
            "worker_batch_size": {{MAIN_SL_BLOCKS_TRANSACTIONS_REALTIME_WORKER_BATCH_SIZE}},
            "async_concurrent_requests": {{MAIN_SL_BLOCKS_TRANSACTIONS_REALTIME_ASYNC_CONCURRENT_REQUESTS}},
...
LIMIT {{MAIN_SL_BLOCKS_TRANSACTIONS_REALTIME_SQL_LIMIT}}