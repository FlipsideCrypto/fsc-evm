{%- set state_root_contract = '0x56315b90c40730925ec5485cf004d835058518A0' -%}
...
WITH base AS (
    ...
    FROM
        {{ source('ethereum_logs', 'op_stack_state_hashes') }}
    WHERE
        topics [0] :: STRING = '0xa7aaf2512769da4e444e3de247be2564225c2e7a8f74cfe528e46e17d24868e2'
        AND contract_address = '{{ state_root_contract }}'
...
SELECT
    ...
    CASE
        WHEN '{{ target.database }}' = 'OPTIMISM' THEN min_l2_block_number - 1800
