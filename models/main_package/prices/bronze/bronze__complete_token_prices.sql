{# Set variables #}
{%- set token_addresses = get_get_var('MAIN_PRICES_TOKEN_ADDRESSES', none) -%}
{%- set blockchains = get_get_var('MAIN_PRICES_TOKEN_BLOCKCHAINS', get_get_var('GLOBAL_PROD_DB_NAME', '').lower() ) -%}
