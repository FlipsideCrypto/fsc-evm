...
- `amount_minted`: daily amount minted
- `amount_burned`: daily amount burned
- `amount_in_bridges`: Amount held in Bridge vaults
- `amount_in_dex_liquidity_pools`: Amount held in DEX liquidity pools
- `amount_in_lending_pools`: Amount held in lending protocols
...
{% docs ez_stablecoins_supply_contract_address %}

The smart contract address of the stablecoin token.
