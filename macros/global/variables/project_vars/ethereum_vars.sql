{% macro ethereum_vars() %}
    {% set vars = {
        ...
        'BALANCES_SL_ERC20_DAILY_HISTORY_SQL_LIMIT': 12000000,
        'BALANCES_SL_ERC20_DAILY_HISTORY_PRODUCER_BATCH_SIZE': 600000,
        'BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE': 60000,
        'BALANCES_SL_ERC20_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS': 10,
        'BALANCES_SL_NATIVE_DAILY_HISTORY_SQL_LIMIT': 12000000,
        'BALANCES_SL_NATIVE_DAILY_HISTORY_PRODUCER_BATCH_SIZE': 600000,
        'BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE': 60000,
        'BALANCES_SL_NATIVE_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS': 10,
        'BALANCES_SL_ERC20_DAILY_REALTIME_PRODUCER_BATCH_SIZE': 240000,
        'BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE': 60000,
        'BALANCES_SL_ERC20_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS': 10,
        'BALANCES_SL_NATIVE_DAILY_REALTIME_PRODUCER_BATCH_SIZE': 240000,
        'BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE': 60000,
        ...
        'CURATED_DEFI_BRIDGE_RECENCY_EXCLUSION_LIST': ['multichain-v7','symbiosis-v1','axie_infinity-v2','across-v1','near_rainbow_bridge-v1','hop-v1'],
