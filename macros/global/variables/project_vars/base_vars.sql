{% macro base_vars() %}
    {% set vars = {
        ...
        'BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE': 63000,
        'BALANCES_SL_NATIVE_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS': 10,
        'CURATED_DEFI_RECENCY_EXCLUSION_LIST': ['voodoo-v1','woofi-v1','woofi-v3','across-v1','celer_cbridge-v1','hop-v1','symbiosis-v1','seamless-v1','granary-v1'],
