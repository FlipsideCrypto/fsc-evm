{% macro ink_vars() %}
    {% set vars ={ 'GLOBAL_PROJECT_NAME': 'ink',
    ...
    'CURATED_DEFI_BRIDGE_CONTRACT_MAPPING':{ 'across':{ 'v3':{ 'funds_deposited': '0xef684c38f94f48775959ecf2012d7e864ffb9dd4' }},
    'layerzero':{ 'v2':{ 'bridge': '0xca29f3a6f966cb2fc0de625f8f325c0c46dbe958' }},
    'stargate':{ 'v2':{ 'bridge': '0x45f1a95a4d3f3836523f5c83673c797f4d4d263b' }}} 'CURATED_BRIDGE_STARGATE_TOKEN_MESSAGING_CONTRACT': '0x45f1a95a4d3f3836523f5c83673c797f4d4d263b',
