{% macro return_vars() %}
  ...
  {% set ns.DEXALOT_GHA_STREAMLINE_CHAINHEAD_CRON = get_var('DEXALOT_GHA_STREAMLINE_CHAINHEAD_CRON', none) %}
  {% set ns.DEXALOT_GHA_SCHEDULED_MAIN_CRON = get_var('DEXALOT_GHA_SCHEDULED_MAIN_CRON', none) %}
