{% macro return_vars() %}
  ...
  {% set ns.CURATED_LAYERZERO_ENDPOINT_V2_CONTRACT = get_var('CURATED_LAYERZERO_ENDPOINT_V2_CONTRACT', '') %}
  {% set ns.CURATED_STARGATE_TOKEN_MESSAGING_CONTRACT = get_var('CURATED_STARGATE_TOKEN_MESSAGING_CONTRACT', '') %}
