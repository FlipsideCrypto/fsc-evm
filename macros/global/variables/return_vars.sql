{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE', 50 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE', 50 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE', 50 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE', 50 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
