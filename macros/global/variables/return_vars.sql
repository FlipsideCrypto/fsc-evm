{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_SQL_LIMIT', 5000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_PRODUCER_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE', 35 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS', 20) %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_PRODUCER_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE', 35 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS', 20) %}

  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_SQL_LIMIT', 5000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_PRODUCER_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE', 35 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_ASYNC_CONCURRENT_REQUESTS', 20) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_PRODUCER_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE', 35 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_ASYNC_CONCURRENT_REQUESTS', 20) %}
  ...
  {# Curated Stablecoins Variables #}
  {% set ns.CURATED_DEFI_STABLECOINS_NATIVE_MINT_BURN_BRIDGE_LIST = get_var('CURATED_DEFI_STABLECOINS_NATIVE_MINT_BURN_BRIDGE_LIST', []) %}
  {% set ns.CURATED_DEFI_STABLECOINS_BRIDGE_VAULT_MAPPING = get_var('CURATED_DEFI_STABLECOINS_BRIDGE_VAULT_MAPPING', {}) %}
