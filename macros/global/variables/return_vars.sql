{% macro return_vars() %}
  ...
  {# AAVE Chain-Specific Addresses #}
  {# Ethereum #}
  {% set ns.PROTOCOL_AAVE_V3_POOL_ETHEREUM = get_var('PROTOCOL_AAVE_V3_POOL_ETHEREUM', '0x87870bca3f3fd6335c3f4ce8392d69350b4fa4e2') %}
  {% set ns.PROTOCOL_AAVE_V2_POOL_ETHEREUM = get_var('PROTOCOL_AAVE_V2_POOL_ETHEREUM', '0x7d2768de32b0b80b7a3454c06bdac94a69ddc7a9') %}
  {% set ns.PROTOCOL_AAVE_COLLECTOR_V3_ETHEREUM = get_var('PROTOCOL_AAVE_COLLECTOR_V3_ETHEREUM', '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c') %}
  {% set ns.PROTOCOL_AAVE_COLLECTOR_V2_ETHEREUM = get_var('PROTOCOL_AAVE_COLLECTOR_V2_ETHEREUM', '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c') %}
