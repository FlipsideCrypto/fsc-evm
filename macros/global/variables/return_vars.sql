{% macro return_vars() %}
  ...
  {# Curated Variables #}
  {% set ns.CURATED_NADO_OFFCHAIN_EXCHANGE_CONTRACT = get_var('CURATED_NADO_OFFCHAIN_EXCHANGE_CONTRACT', '') %}
  {% set ns.CURATED_NADO_CLEARINGHOUSE_CONTRACT = get_var('CURATED_NADO_CLEARINGHOUSE_CONTRACT', '') %}
  {% set ns.CURATED_NADO_TOKEN_MAPPING = get_var('CURATED_NADO_TOKEN_MAPPING', {}) %}
