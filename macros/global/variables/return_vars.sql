{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_BATCH_SIZE', 500 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
