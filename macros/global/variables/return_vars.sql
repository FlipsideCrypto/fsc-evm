{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SILVER_STATE_TRACER_FR_MAX_BLOCK = get_var('BALANCES_SILVER_STATE_TRACER_FR_MAX_BLOCK', 1000000) %}
  {% set ns.BALANCES_SILVER_STATE_TRACER_FULL_RELOAD_BLOCKS_PER_RUN = get_var('BALANCES_SILVER_STATE_TRACER_FULL_RELOAD_BLOCKS_PER_RUN', 1000000) %}
