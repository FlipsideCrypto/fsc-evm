{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_DAILY_HISTORY_BATCH_SIZE = get_var('BALANCES_SL_DAILY_HISTORY_BATCH_SIZE', 1000000) %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SQL_LIMIT', 5000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SQL_LIMIT', 5000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
