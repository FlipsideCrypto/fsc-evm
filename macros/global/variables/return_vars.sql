{% macro return_vars() %}
  ...
  {% set ns.CURATED_DEX_SWAPS_V2_CONTRACT_MAPPING = get_var('CURATED_DEX_SWAPS_V2_CONTRACT_MAPPING', {}) %}
  {% set ns.CURATED_DEX_UNISWAP_V2_DETAILS = get_var('CURATED_DEX_UNISWAP_V2_DETAILS', '') %}
  {% set ns.CURATED_DEX_SUSHISWAP_V2_DETAILS = get_var('CURATED_DEX_SUSHISWAP_V2_DETAILS', '') %}
