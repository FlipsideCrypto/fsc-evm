{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_START_DATE = get_var('BALANCES_SL_START_DATE', '2025-01-01') %}

  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_REALTIME_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_SQL_LIMIT = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_DAILY_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_REALTIME_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  ...
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_DAILY_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS', 10) %}
