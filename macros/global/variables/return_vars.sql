{% macro return_vars() %}
  ...
  {% set ns.CURATED_DEFI_BRIDGE_SOURCE_CHAIN = get_var('CURATED_DEFI_BRIDGE_SOURCE_CHAIN', '') %}
  ...
  {% set ns.CURATED_DEFI_DEX_POOLS_CONTRACT_MAPPING = get_var('CURATED_DEFI_DEX_POOLS_CONTRACT_MAPPING', {}) %}
