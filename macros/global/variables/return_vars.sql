{% macro return_vars() %}
  ...
  {% set ns.MAIN_SL_TOKEN_READS_REALTIME_SQL_LIMIT = get_var('MAIN_SL_TOKEN_READS_REALTIME_SQL_LIMIT', 50) %}
  {% set ns.MAIN_SL_TOKEN_READS_REALTIME_PRODUCER_BATCH_SIZE = get_var('MAIN_SL_TOKEN_READS_REALTIME_PRODUCER_BATCH_SIZE', 1) %}
  {% set ns.MAIN_SL_TOKEN_READS_REALTIME_WORKER_BATCH_SIZE = get_var('MAIN_SL_TOKEN_READS_REALTIME_WORKER_BATCH_SIZE', 1) %}
  {% set ns.MAIN_SL_TOKEN_READS_REALTIME_ASYNC_CONCURRENT_REQUESTS = get_var('MAIN_SL_TOKEN_READS_REALTIME_ASYNC_CONCURRENT_REQUESTS', 1) %}
