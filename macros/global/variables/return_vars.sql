{% macro return_vars() %}
  ...
  {% set ns.BALANCES_SL_START_BLOCK = get_var('BALANCES_SL_START_BLOCK', 0) %}

  {% set ns.BALANCES_SL_ERC20_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_ERC20_REALTIME_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_REALTIME_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_REALTIME_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_REALTIME_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_REALTIME_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_ERC20_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_ERC20_HISTORY_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_HISTORY_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_HISTORY_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_HISTORY_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_ERC20_HISTORY_SNAPSHOT_SQL_LIMIT = get_var('BALANCES_SL_ERC20_HISTORY_SNAPSHOT_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE = get_var('BALANCES_SL_ERC20_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_ERC20_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_ERC20_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_NATIVE_REALTIME_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_REALTIME_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_REALTIME_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_REALTIME_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_REALTIME_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_REALTIME_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_REALTIME_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_REALTIME_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_NATIVE_HISTORY_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_HISTORY_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_HISTORY_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_HISTORY_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_HISTORY_ASYNC_CONCURRENT_REQUESTS', 10) %}

  {% set ns.BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_SQL_LIMIT = get_var('BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_SQL_LIMIT', 10000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_PRODUCER_BATCH_SIZE', 1000 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE = get_var('BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_WORKER_BATCH_SIZE', 100 * ns.MAIN_SL_BLOCKS_PER_HOUR) %}
  {% set ns.BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS = get_var('BALANCES_SL_NATIVE_HISTORY_SNAPSHOT_ASYNC_CONCURRENT_REQUESTS', 10) %}
