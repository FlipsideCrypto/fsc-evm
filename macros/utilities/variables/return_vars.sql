{% macro return_vars() %}
  ...
  {% set ns.MAIN_SL_BLOCKS_TRANSACTIONS_EXTERNAL_TABLE = 'blocks_transactions' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_blocks_transactions' %}
  ...
  {% set ns.MAIN_SL_RECEIPTS_EXTERNAL_TABLE = 'receipts' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_receipts' %}
  ...
  {% set ns.MAIN_SL_RECEIPTS_BY_HASH_EXTERNAL_TABLE = 'receipts_by_hash' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_receipts_by_hash' %}
  ...
  {# SL Traces Variables #}
  {% set ns.MAIN_SL_TRACES_EXTERNAL_TABLE = 'traces' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_traces' %}
  ...
  {% set ns.MAIN_SL_CONFIRM_BLOCKS_EXTERNAL_TABLE = 'confirm_blocks' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_confirm_blocks' %}
  ...
  {# SL Bronze Variables #}
  {% set ns.MAIN_SL_BRONZE_BLOCKS_SOURCE_NAME = 'blocks' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_blocks' %}
  {% set ns.MAIN_SL_BRONZE_CONFIRM_BLOCKS_SOURCE_NAME = 'confirm_blocks' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_confirm_blocks' %}
  {% set ns.MAIN_SL_BRONZE_RECEIPTS_SOURCE_NAME = 'receipts' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_receipts' %}
  {% set ns.MAIN_SL_BRONZE_RECEIPTS_BY_HASH_SOURCE_NAME = 'receipts_by_hash' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_receipts_by_hash' %}
  {% set ns.MAIN_SL_BRONZE_TRACES_SOURCE_NAME = 'traces' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_traces' %}
  {% set ns.MAIN_SL_BRONZE_TRANSACTIONS_SOURCE_NAME = 'transactions' if ns.GLOBAL_NETWORK_NAME == 'mainnet' else ns.GLOBAL_NETWORK_NAME.lower() ~ '_transactions' %}
