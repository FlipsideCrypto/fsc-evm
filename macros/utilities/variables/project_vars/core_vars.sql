{% macro core_vars() %}
    {% set vars = {
        ...
        'DECODER_ABIS_EXPLORER_NAME': 'CoreScan',
        'DECODER_ABIS_EXPLORER_URL': 'https://openapi.coredao.org/api?module=contract&action=getabi&address=',
        'DECODER_ABIS_EXPLORER_API_KEY_VAULT_PATH': 'Vault/prod/block_explorers/core_scan'
    } %}
